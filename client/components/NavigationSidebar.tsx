...
const NavigationSidebar = () => {
  ...
  return (
    <aside
      className="border border-gray-300 xs:fixed xs:bottom-0 
    xs:bg-white xs:w-full xs:flex xs:justify-center xs:items-center xs:p-2 sm:h-[10%] 
    md:static md:h-[100%] md:w-[30%] md:block"
    >
      <div
        className="sm:place-content-start sm:flex sm:flex-col sm:items-center 
